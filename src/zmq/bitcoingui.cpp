...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a Ttm address"));
    sendCoinsMenuAction->setToolTip(sendCoinsMenuAction->statusTip());

    privateSendCoinsMenuAction = new QAction("&PrivateSend", this);
    privateSendCoinsMenuAction->setStatusTip(tr("PrivateSend coins to a Ttm address"));
    ...
    receiveCoinsMenuAction->setStatusTip(tr("Request payments (generates QR codes and ttm: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about Ttm Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ttm addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ttm addresses"));
    ...
    openAction->setStatusTip(tr("Open a ttm: URI or payment request"));

    showHelpMessageAction = new QAction(tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Ttm command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (fNetworkActive) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ttm network", "", count));
    } else {
...
void BitcoinGUI::updateWidth()
{
    ...
    // Use nButtonsVisible + 1 <- for the ttm logo
...
{
    QString strTitle = tr("Ttm Core"); // default title
