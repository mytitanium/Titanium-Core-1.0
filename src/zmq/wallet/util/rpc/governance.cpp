...
UniValue gobject_vote_conf(const JSONRPCRequest& request)
{
    ...
    if (!dmn) {
        ...
        resultsObj.push_back(Pair("ttm.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Ttm features */
    { "ttm",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "ttm",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "ttm",               "gobject",                &gobject,                true,  {} },
    { "ttm",               "voteraw",                &voteraw,                true,  {} },
