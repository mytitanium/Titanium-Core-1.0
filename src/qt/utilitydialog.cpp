    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  ttm-qt [" + tr("command-line options") + "]                     " + "\n";
        ...
        strUsage += HelpMessageOpt("-windowtitle=<name>", _("Sets a window title which is appended to \"Ttm Core - \""));
...
All the Ttm in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 TTM, 0.01 TTM, 0.1 TTM, 1 TTM and 10 TTM -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a style=\"%1\" href=\"https://docs.titanium-blocks.org/en/stable/wallets/ttmcore/privatesend-instantsend.html\">PrivateSend documentation</a>."
