...
/** Utility functions used by the Ttm Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "ttm:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load ttm specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a ttm specific theme is activated (light/dark).*/
    bool ttmThemeActive();
