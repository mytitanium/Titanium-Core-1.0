...
//! Interface for the src/evo part of a ttm node (ttmd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a ttm node (ttmd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a ttm node (ttmd process).
...
//! Top-level interface for a ttm node (ttmd process).
class Node
{
public:
    virtual ~Node() {}
