...
This mechanism has been integrated into Bitcore-Node-Ttm which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ttmpay/insight-api-ttm#web-socket-api](https://github.com/ttmpay/insight-api-ttm#web-socket-api)
* API: [https://github.com/ttmpay/insight-api-ttm#instantsend-transactions](https://github.com/ttmpay/insight-api-ttm#instantsend-transactions)
