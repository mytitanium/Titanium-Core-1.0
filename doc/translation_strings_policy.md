...
This document provides guidelines for internationalization of the Titanium software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ttm_en.ts` remains unchanged.
