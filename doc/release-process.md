...
### Titanium maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Titanium for Linux, Windows, and OS X:
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the ttm.org server
