...
* Update translations, see [translation_process.md](https://github.com/mytitanium/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/mytitanium/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/mytitanium.git
...
- Detached signatures will then be committed to the [ttm-detached-sigs](https://github.com/mytitanium-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the titanium-blocks.org server*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the titanium-blocks.org server

- Update titanium-blocks.org

- Announce the release:

  - Release on Ttm forum: https://www.titanium-blocks.org/forum/topic/official-announcements.54/

  - Optionally Discord, twitter, reddit /r/Ttmpay, ... but this will usually sort out itself

  - Notify flare so that he can start building [the PPAs](https://launchpad.net/~titanium-blocks.org/+archive/ubuntu/ttm)

  - Archive release notes for the new version to `doc/release-notes/` (branch `master` and branch of the release)

  - Create a [new GitHub release](https://github.com/mytitanium/releases/new) with a link to the archived release notes.
