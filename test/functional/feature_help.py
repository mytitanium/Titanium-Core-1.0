...
"""Verify that starting ttmd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ttmd with -h for help text")
        ...
        self.log.info("Start ttmd with -version for version information")
