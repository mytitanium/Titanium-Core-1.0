...
class WalletUpgradeToHDTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(node.upgradetohd(mnemonic, "", walletpass), "Wallet successfully upgraded and encrypted, Ttm Core server is stopping. Remember to make a backup before restarting.")
