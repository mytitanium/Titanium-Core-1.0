# Linearize
Construct a linear, no-fork, best version of the Ttm blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install ttm_hash

https://github.com/ttmpay/ttm_hash
...
JSON-RPC server. Running `ttmd` or `ttm-qt -server` will be sufficient.
...
* `input`: ttmd blocks/ directory containing blkNNNNN.dat
