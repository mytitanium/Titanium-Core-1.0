Contributing to Ttm Core
============================

The Ttm Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/mytitanium/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Ttm Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Ttm
Network Protocol consensus changes.

Whether a pull request is merged into Ttm Core rests with the project merge
...
Patches that change Ttm consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ttm consensus, it must have been
...
The review process is normally fairly responsive on the Ttm Core repository, however
...
The project leader is the release manager for each Ttm Core release.
